...
const vehicleData = require('../models/vehical.model');
...
router.get('/',(req,res)=>{
    res.send('<h2>This is vehicle crud</h2><a href="/add"> ADD</a><br><a href="/list"> List</a>');
})
...
router.post('/save',upload.single('file'),(req,res)=>{
    ...
    var vd=new vehicleData({
        ...
        depriciation:req.body.depriciation,
